...
const tones: Record<Tone, string> = {
  ...
  neutral: "bg-obsidian-600 text-platinum-300 ring-1 ring-inset ring-obsidian-400/60",
  down: "bg-[var(--color-down)]/15 text-[var(--color-down)] ring-1 ring-inset ring-[var(--color-down)]/30",
...
export function Badge(
  { tone = "neutral", dot = false, class: className = "", children }: BadgeProps,
) {
  return (
    <span
